...
func (app *BaseApp) BeginBlock(req abci.RequestBeginBlock) (res abci.ResponseBeginBlock) {
	...
	if app.beginBlocker != nil {
		...
		app.AddStreamEvents(req.Header.Height, req.Header.Time, res.Events, false)
...
func (app *BaseApp) EndBlock(req abci.RequestEndBlock) (res abci.ResponseEndBlock) {
	...
	if app.endBlocker != nil {
		...
		app.AddStreamEvents(req.Height, app.deliverState.ctx.BlockTime(), res.Events, true)
		res.Events = sdk.MarkEventsToIndex(res.Events, app.indexEvents)
	}
...
func (app *BaseApp) DeliverTx(req abci.RequestDeliverTx) (res abci.ResponseDeliverTx) {
	...
	app.AddStreamEvents(app.checkState.Context().BlockHeight(), app.checkState.Context().BlockTime(), result.Events, false)
