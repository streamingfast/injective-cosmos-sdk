...
type Block struct {
	Header *tmservice.Header      `protobuf:"bytes,1,opt,name=header,proto3" json:"header,omitempty"`
...
func (m *Block) GetHeader() *tmservice.Header {
	if m != nil {
		return m.Header
	}
	return nil
...
type RequestFinalizeBlock struct {
	...
	DecidedLastCommit types.CommitInfo    `protobuf:"bytes,2,opt,name=decided_last_commit,json=decidedLastCommit,proto3" json:"decided_last_commit"`
	Misbehavior       []types.Misbehavior `protobuf:"bytes,3,rep,name=misbehavior,proto3" json:"misbehavior"`
...
func (m *RequestFinalizeBlock) GetDecidedLastCommit() types.CommitInfo {
	if m != nil {
...
func (m *RequestFinalizeBlock) GetMisbehavior() []types.Misbehavior {
	if m != nil {
...
type ResponseFinalizeBlock struct {
	...
	ValidatorUpdates []types.ValidatorUpdate `protobuf:"bytes,3,rep,name=validator_updates,json=validatorUpdates,proto3" json:"validator_updates"`
...
func (m *ResponseFinalizeBlock) GetEvents() []types.Event {
	if m != nil {
		return m.Events
	}
	return nil
...
func (m *ResponseFinalizeBlock) GetValidatorUpdates() []types.ValidatorUpdate {
	if m != nil {
...
func (m *ExecTxResult) GetEvents() []types.Event {
	if m != nil {
		return m.Events
	}
	return nil
...
var fileDescriptor_00cc0742f1187630 = []byte{
	...
	,
}
...
func (m *RequestFinalizeBlock) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Misbehavior = append(m.Misbehavior, types.Misbehavior{})
