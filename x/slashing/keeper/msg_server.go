...
func (k msgServer) UpdateParams(goCtx context.Context, msg *types.MsgUpdateParams) (meterResult *types.MsgUpdateParamsResponse, err error) {
...
func (k msgServer) Unjail(goCtx context.Context, msg *types.MsgUnjail) (meterResult *types.MsgUnjailResponse, err error) {
	sdkCtx := sdk.UnwrapSDKContext(goCtx)
	defer k.Keeper.Meter(goCtx).FuncTiming(&sdkCtx, "Unjail")(&err)
